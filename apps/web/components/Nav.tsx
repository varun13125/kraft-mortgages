  ...
  return (
    <>
      ...
      <nav className="hidden lg:flex items-center gap-6">
        ...
        <Link href="/blog" className="text-sm font-medium text-gray-300 hover:text-gold-400 transition-colors">
          Blog
        </Link>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Link
                  ...
                  className="flex items-center px-3 py-2 rounded-lg hover:bg-gray-700 transition-colors"
                >
                  <span className="text-sm font-medium text-gray-200">Learn</span>
                </Link>
                <Link
                  href="/blog"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center px-3 py-2 rounded-lg hover:bg-gray-700 transition-colors"
                >
                  <span className="text-sm font-medium text-gray-200">Blog</span>
                </Link>
              </div>
