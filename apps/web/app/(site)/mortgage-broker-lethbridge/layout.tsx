...
export default function LethbridgeLayout({ children }: { children: React.ReactNode }) {
    return (
    <>
      <CityServiceJsonLd cityName="Lethbridge" provinceName="AB" description="Licensed mortgage broker serving Lethbridge, AB. Residential, construction, self-employed, MLI Select, and private lending solutions." />
      {children}
    </>
  );
}
