...
export const metadata: Metadata = {
  ...
  description: 'Licensed Kelowna mortgage broker with $2B+ funded and 23+ years experience. Expert in residential, commercial, construction, and private lending. Free pre-approval in 24 hours.',
