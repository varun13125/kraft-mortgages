...
export const metadata: Metadata = {
  ...
  description: "Expert construction mortgage financing in BC, Alberta & Ontario. Progressive draws, construction-to-permanent loans, builder programs, and land development financing. 23+ years experience.",
