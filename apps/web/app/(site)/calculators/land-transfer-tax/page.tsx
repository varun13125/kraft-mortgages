...
function bcFTHRRebate(price: number): number {
  if (price <= 500000) return 1.0; // full exemption — use bcPTT total
  if (price <= 525000) return (525000 - price) / 25000;
  return 0;
}
      ...
      <main className="min-h-screen mt-16">
        ...
        <section className="py-16 px-4 border-t border-white/10">
          <div className="max-w-4xl mx-auto prose prose-invert">
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              <strong>First-Time Home Buyers&apos; Program:</strong> First-time buyers in BC may be fully exempt from the PTT on homes up to $500,000. A partial exemption applies for homes between $500,000 and $525,000. To qualify, you must be a Canadian citizen or permanent resident, have lived in BC for at least 12 months, have never owned an interest in a principal residence anywhere, and the home must be your principal residence.
            </p>
