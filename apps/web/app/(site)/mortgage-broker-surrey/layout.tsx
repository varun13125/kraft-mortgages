...
export const metadata: Metadata = {
  ...
  description: 'Top-rated Surrey mortgage broker with $2B+ funded. Expert in first-time buyers, self-employed mortgages, construction financing, and private lending. Licensed BCFSA #M08001935. Serving Whalley, Fleetwood, Guildford, Newton, Cloverdale & South Surrey.',
