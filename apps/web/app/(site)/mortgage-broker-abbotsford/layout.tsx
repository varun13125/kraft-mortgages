...
export const metadata: Metadata = {
  ...
  description: 'Licensed Abbotsford mortgage broker with $5B+ funded and 18+ years experience. Expert in residential, commercial, construction, and private lending. Free pre-approval in 24 hours.',
